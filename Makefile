...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/fuck-clash/fuck-clash/constant.Version=$(VERSION)" \
		-X "github.com/fuck-clash/fuck-clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
